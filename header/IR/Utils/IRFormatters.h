...
inline std::string FormatIR(TokenStream& tokenStream, bool history = false) { return FormatTokens(tokenStream); }
inline std::string FormatIR(Node& AST, bool history = false) { return FormatAST(AST); }
inline std::string FormatIR(CFG& CFG, bool history = false) { return FormatCFG(CFG); }
...
inline std::string FormatIR(std::string AsmFilePath, bool history = false) { return GetASM(AsmFilePath); }
